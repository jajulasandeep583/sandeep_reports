frappe.query_reports["Debtors Summary - Split"] = {
    filters: [
        {
            fieldname: "company",
            label: __("Company"),
    ...
    onload: function (report) {
        report.page.add_inner_button(__("Export to Excel"), function () {
            ...
            // Header row
            var headers = ["Customer","Opening","Sales Invoice","Debit Note","Credit Note","Received","Outstanding"];
            ...
            data.forEach(function (row) {
                ...
                var cells = [
                    ...
                    {v: row.sales_invoice, c: "#2980b9"},
                    {v: row.debit_note,    c: "#2980b9"},
                    {v: row.credit_note,   c: "#8e44ad"},
                    {v: row.received,      c: "#27ae60"},
            ...
            a.href     = url;
            a.download = "Debtors_Summary_Split_" + as_on + ".xls";
    ...
    formatter: function (value, row, column, data, default_formatter) {
        ...
        if ((column.fieldname === "sales_invoice" || column.fieldname === "debit_note") && value) {
